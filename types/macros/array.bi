...
property _a_##array.data () as _t_ const ptr
    return this._p
end property
...
function _a_##array.forEach overload (f as sub (byref as _t_), byref r as const boolean => false) as boolean
    if this._l then
        if f then
...
function _a_##array.forEach (f as function (byref as _t_) as boolean, byref r as const boolean => false) as boolean
    if this._l then
        if f then
...
function _a_##array.forEach (f as function (byref as _t_, byref as const integer) as boolean, byref r as const boolean => false) as boolean
    if this._l then
        if f then
